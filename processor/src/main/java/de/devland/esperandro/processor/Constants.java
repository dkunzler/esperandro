...
public class Constants {
    ...
    public static final String[] STANDARD_IMPORTS = new String[]{"android.os.Build", "android.content.Context", "android.content.SharedPreferences", "android.annotation.SuppressLint", "de.devland.esperandro.Esperandro"};
    public static final String SHARED_PREFERENCES_ANNOTATION_NAME = "de.devland.esperandro.annotations" + "" +
            ".SharedPreferences";

    public static final Set<Modifier> MODIFIER_PRIVATE = new HashSet<Modifier>(Arrays.asList(Modifier.PRIVATE));
    public static final Set<Modifier> MODIFIER_PRIVATE_FINAL = new HashSet<Modifier>(Arrays.asList(Modifier.PRIVATE,
            Modifier.FINAL));
